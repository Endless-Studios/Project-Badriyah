...
public class ABC_Controller : MonoBehaviour {
    ...
    public class Weapon {
        ...
        /// </summary>
        [Tooltip("he IDs of the abilities this weapon will enable")]
            ...
            switch (WeaponToggleType) {
                case WeaponState.Equip:
                    ...
                    if (this.enableAbilitiesWhenEquipped) {
                        ...
                        foreach (int abilityID in this.enableAbilityIDs)
                        ...
                        if (this.disableAllOtherAbilitiesNotListed) {
                            ...
                            foreach (int abilityID in Originator.CurrentAbilities.Where(a => this.enableAbilityIDs.Contains(a.abilityID) == false).Select(a => a.abilityID).ToList()) {
                            ...
                            foreach (int abilityID in Originator.CurrentAbilities.Where(a => this.enableAbilityIDs.Contains(a.abilityID) == false).Select(a => a.abilityID).ToList()) {
                                ...
                                if (Originator.AllWeapons.Where(w => w.enableAbilityIDs.Contains(abilityID) == true).ToList().Count() > 0) {
                                    Originator.DisableAbility(abilityID);
                                }
                            }
                    ...
                    if (this.disableAbilitiesWhenEquipped) {
                        ...
                        foreach (int abilityID in this.disableAbilityIDs)
                            Originator.DisableAbility(abilityID);
                        ...
                        if (this.enableAllOtherAbilitiesNotListed) {
                            ...
                            foreach (int abilityID in Originator.CurrentAbilities.Where(a => this.disableAbilityIDs.Contains(a.abilityID) == false).Select(a => a.abilityID).ToList()) {
                                Originator.EnableAbility(abilityID);
                            }
    ...
    private bool ActivateAbility(ABC_Ability Ability, bool IgnoreTriggerCheck = false, bool IgnoreActivationPermittedCheck = false, bool IgnoreComboCheck = false) {
        ...
        if (Ability.Activate(meEntity, IgnoreTriggerCheck, IgnoreActivationPermittedCheck, IgnoreComboCheck)) {
        ...
        foreach (AIRule rule in enabledAIRules.Where(a => a.AIActive == true)) {
            ...
            switch (rule.selectedAIAction) {
                case AIRule.AIAction.ActivateAbility:
                    ...
                    if (this.ActivateAbility(ability, true, false, true) == false) {
    ...
    private void AINavigationHandler() {
        ...
        if (this.idleModeBeingToggled == true && this.navAIPreventMovementWhenSwitchingIdleMode) {
            ...
            this.meNavAgent.speed = this.moveForwardSpeed;
            ...
            this.meNavAgent.speed = this.speed;
    ...
    private bool AINavigationEntityInSight(Transform Entity) {
        ...
        if (dot >= 0.3) {
            ...
            if (Physics.Raycast(ray, out rayHit)) {
                ...
                if (rayHit.transform != Entity.transform)
                    return false;
